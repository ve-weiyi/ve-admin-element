...
import type { CreateNotifyTemplateReq } from "@/api/types";
import { NotifyTemplateAPI } from "@/api";
import { SwitchEnum } from "@/enums/blog";

const modalConfig: IModalConfig<CreateNotifyTemplateReq> = {
  ...
  formAction(data) {
    return NotifyTemplateAPI.createNotifyTemplate(data);
  },
  beforeSubmit(data) {
