...
const modalConfig: IModalConfig<CreateNotifyMessageReq> = {
  ...
  formAction(data) {
    return NotifyMessageAPI.createNotifyMessage(data);
  },
  beforeSubmit(data) {
