    ...
    <el-form ref="menuFormRef" :model="menuForm" :rules="menuFormRules" label-width="100px">
      ...
      <el-form-item v-if="menuForm.type !== MenuTypeEnum.BUTTON" prop="visible" label="显示状态">
        <el-radio-group v-model="menuForm.visible">
          <el-radio :value="MenuVisibleEnum.VISIBLE">显示</el-radio>
          <el-radio :value="MenuVisibleEnum.HIDDEN">隐藏</el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      >
        ...
        <el-radio-group v-model="menuForm.always_show">
          <el-radio :value="SwitchEnum.ON">是</el-radio>
          <el-radio :value="SwitchEnum.OFF">否</el-radio>
        </el-radio-group>
      </el-form-item>
...
import { MenuTypeEnum, MenuVisibleEnum, SwitchEnum } from "@/enums/blog";
...
const menuForm = defineModel<CreateMenuReq>({ required: true });
...
const getMenuOptions = () => {
  MenuAPI.queryMenuList().then((res) => {
