...
import { findMenuListApi } from "@/api/menu";
...
<template>
  <div>
    <el-form ref="menuFormRef" :model="menuForm" :rules="menuFormRules" label-width="100px">
      ...
      <el-form-item
        v-if="menuForm.type == MenuTypeEnum.CATEGORY || menuForm.type == MenuTypeEnum.MENU"
        prop="path"
      >
        <template #label>
          <div>
      ...
      <el-form-item v-if="menuForm.type == MenuTypeEnum.CATEGORY" label="跳转路由">
